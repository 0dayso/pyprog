...
drop table pt.kpi_total_monthly;
create table pt.kpi_total_monthly
(
time_id    int,
zb_code    varchar(64),
zb_name    varchar(64),
...
insert into pt.kpi_total_monthly
(time_id,zb_code,zb_name,channel_code,value,yesterday,last_month,last_year,level)
values
(201708,'OLDM','jdjd','HB',1,2,3,4,1);
...
create table st.kpi_comp_cd005_m_vertical
(
op_time    varchar(32),
dim_code   varchar(64),
dim_val    varchar(64),
